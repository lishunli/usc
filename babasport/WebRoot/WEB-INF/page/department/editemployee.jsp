...
<html:hidden property="username"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
	...
	<tr bgcolor="f5f5f5"> 
     ...
     <c:if test="${!empty imagePath}"><img src="${imagePath}" border="0" height="30"></c:if> </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <c:forEach items="${departments}" var="department" varStatus="statu">      
      	<input <c:if test="${selectdepartmentid==department.id}">checked</c:if>
      	 type="radio" name="departmentid" value="${department.id}">${department.name}	
