    ...
    <TD>
      ...
      <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
        ...
        <TR>
          ...
          <TD><html:text property="recipients" maxlength="30" size="30"/><FONT color="#ff0000">*</FONT>&nbsp;<html:radio property="gender" value="MAN"/>先生 <html:radio property="gender" value="WOMEN"/>女士</TD></TR>
        <TR>
          <TD height="27">
        ...
        <TR id="buyerinfoInput" style="DISPLAY: none">
		  ...
		  <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
            <TR>
              ...
              <TD align="left"><html:text property="buyer" maxlength="30" size="30" />
              &nbsp;<html:radio property="buyer_gender" value="MAN" />先生 <html:radio property="buyer_gender" value="WOWEN"/>女士</TD>
            </TR>
            <TR>
