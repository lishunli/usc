...
public class LogUtils {
	...
	public static String sqlValueToString(Object object) {
		/*
		 * if (o == null) return "null"; if (o instanceof String) return "'" +
		 * o.toString() + "'"; else if (o instanceof Reader &&
		 * ConfigurationParameters.logText) { return readFromReader((Reader) o);
