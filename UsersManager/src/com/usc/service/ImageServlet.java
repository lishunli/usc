...
public class ImageServlet extends HttpServlet
{
	...
	// // g.setColor(getRandColor(160,200));
	// g.setColor(new
	// Color(20+random.nextInt(110),20+random.nextInt(110),20+random
	...
	public String tranPOST(String buffer_)
	{/* 编码翻译 */
		try
		{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	{
		try
		{
			...
			request.getSession().setAttribute("verify",
					writeImg(response.getOutputStream()));
			// System.out.println("verifycodeold:"+request.getSession().
