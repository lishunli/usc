...
public class GoogleCodeDownloadURL extends javax.swing.JFrame
{
	...
	private static final long serialVersionUID = -3971409323768202519L;
	...
	private void initComponents()
	{
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addGap(227, 227, 227).addComponent(jLabel1).addGap(237, 237, 237)).addGroup(
				javax.swing.GroupLayout.Alignment.TRAILING,
				layout.createSequentialGroup().addContainerGap().addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
								layout.createSequentialGroup().addGap(248, 248, 248).addComponent(jButton1)).addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
	...
	private void jButton1MouseClicked(java.awt.event.MouseEvent evt)
	{
		...
		// jEditorPane1
		jEditorPane2
		.setText("<html><body>顺利提供下载：<br>文&nbsp;件&nbsp;名："
				+ fileName
				+ "<br>下载地址："
				+ "<a href="
				...
				+ googleCodeDownLoadURL
				+ " target='_blank'>"
				+ "<img style='display: inline' title='顺利提醒您请点击下载文件' alt='请复制上面的链接下载' src='http://www.blogjava.net/images/blogjava_net/lishunli/WindowsLiveWriter/DownLoad_F947/download_6.gif' width='120' height='34'>"
				+ "</a></body></html>");
