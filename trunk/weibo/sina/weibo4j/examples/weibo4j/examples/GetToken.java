	...
	public static void main(String[] args) {
		...
		try {
			...
			while (null == accessToken) {
				...
				System.out.println(requestToken.getAuthorizationURL("http://127.0.0.1:85/xlgame_youxi/weibo?action=callBack"));
				BareBonesBrowserLaunch.openURL(requestToken.getAuthorizationURL("http://127.0.0.1:85/xlgame_youxi/sinaweibo?action=callBack"));
