...
public class BaseDao {
    ...
    static {
        ...
        // dataSource.setPassword("wxy0y4i3hxzli5150402h1lw4jkh3hzwmh5xi0z2");
    ...
    protected <T> List<T> queryListSQL(Class<T> clazz, String sql, Object[] args) {
        ...
        if (args != null && args.length > 0) {
            mapList = getJdbcTemplate().queryForList(sql, args);
        } else {
            mapList = getJdbcTemplate().queryForList(sql);
        }
    ...
    protected Integer queryCountSQL(String sql, Object[] args) {
        return Long.valueOf(getJdbcTemplate().queryForLong(sql, args)).intValue();
    }
