...
public class Info_API extends RequestAPI {
	 ...
	 * @throws Exception
	 */
	public String update(OAuth oauth, String format, String op, String type) throws Exception {
		...
		return getResource("http://open.t.qq.com/api/info/update", parameters, oauth);
	}
}
