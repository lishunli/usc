...
public class Private_API extends RequestAPI {
	 ...
	 * @throws Exception
	 */
	public String add(OAuth oauth, String format, String content, String clientip, String name) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String add(OAuth oauth, String format, String content, String clientip, String jing, String wei, String name) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String recv(OAuth oauth, String format, String pageflag, String pagetime, String reqnum) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		...
		return getResource("http://open.t.qq.com/api/private/recv", parameters, oauth);
	}
	 ...
	 * @throws Exception
	 */
	public String send(OAuth oauth, String format, String pageflag, String pagetime, String reqnum) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("pageflag", pageflag));
		parameters.add(new QParameter("pagetime", pagetime));
		parameters.add(new QParameter("reqnum", reqnum));
		return getResource("http://open.t.qq.com/api/private/send", parameters, oauth);
	}
}
