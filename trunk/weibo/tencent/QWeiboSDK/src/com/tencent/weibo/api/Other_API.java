...
public class Other_API extends RequestAPI {
	 ...
	 * @throws Exception
	 */
	public String kownperson(OAuth oauth, String format, String ip, String country_code, String province_code, String city_code) throws Exception {
		...
		return getResource("http://open.t.qq.com/api/other/kownperson", parameters, oauth);
	}
	...
	public String shorturl(OAuth oauth, String format, String url) throws Exception {
		...
		return getResource("http://open.t.qq.com/api/other/shorturl", parameters, oauth);
	}
	...
	public String videokey(OAuth oauth, String format) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		return getResource("http://open.t.qq.com/api/other/videokey", parameters, oauth);
	}
}
