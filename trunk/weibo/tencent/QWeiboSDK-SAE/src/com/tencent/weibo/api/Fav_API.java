...
public class Fav_API extends RequestAPI {
	...
	public String addt(OAuth oauth, String format, String id) throws Exception {
		...
		return postContent("http://open.t.qq.com/api/fav/addt", parameters, oauth);
	}
	...
	public String delt(OAuth oauth, String format, String id) throws Exception {
		...
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("id", id));
		return postContent("http://open.t.qq.com/api/fav/delt", parameters, oauth);
	}
	 ...
	 * @throws Exception
	 */
	public String list_t(OAuth oauth, String format, String pageflag, String pagetime, String reqnum, String lastid) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		...
		return getResource("http://open.t.qq.com/api/fav/list_t", parameters, oauth);
	}
	...
	public String addht(OAuth oauth, String format, String id) throws Exception {
		...
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("id", id));
		return postContent("http://open.t.qq.com/api/fav/addht", parameters, oauth);
	}
	...
	public String delht(OAuth oauth, String format, String id) throws Exception {
		...
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("id", id));
		return postContent("http://open.t.qq.com/api/fav/delht", parameters, oauth);
	}
	 ...
	 * @throws Exception
	 */
	public String list_ht(OAuth oauth, String format, String reqnum, String pageflag, String pagetime, String lastid) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("reqnum", reqnum));
		parameters.add(new QParameter("pageflag", pageflag));
		parameters.add(new QParameter("pagetime", pagetime));
		parameters.add(new QParameter("lastid", lastid));
		return getResource("http://open.t.qq.com/api/fav/list_ht", parameters, oauth);
	}
