...
public class User_API extends RequestAPI {
	...
	public String info(OAuth oauth, String format) throws Exception {
		...
		return getResource("http://open.t.qq.com/api/user/info", parameters, oauth);
	}
	 ...
	 * @throws Exception
	 */
	public String update(OAuth oauth, String format, String nick, String sex, String year, String month, String day, String countrycode, String provincecode, String citycode, String introduction) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
	 ...
	 * @throws Exception
	 */
	public String update_head(OAuth oauth, String format, String picpath) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
	 ...
	 * @throws Exception
	 */
	public String other_info(OAuth oauth, String format, String name) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
	 ...
	 *            返回数据的格式 是（json或xml）
	 * @param feildid
	 *            教育信息记录ID （添加feildid=1.修改填返回的ID,删除下面四个参数为空）
	 * @param year
	 *            入学年限
	 * @param Schoolid
	 *            学校ID
	 ...
	 * @throws Exception
	 */
	public String update_edu(OAuth oauth, String format, String feildid, String year, String schoolid, String departmentid, String level) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		...
		return postContent("http://open.t.qq.com/api/user/update_edu", parameters, oauth);
	}
	 ...
	 *            返回数据的格式 是（json或xml）
	 * @param names
	 *            用户ID列表 比如 abc,edf,xxxx
	 * @return
	 * @throws Exception
	 */
	public String infos(OAuth oauth, String format, String names) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("names", names));

		return getResource("http://open.t.qq.com/api/user/infos", parameters, oauth);
	}
}
