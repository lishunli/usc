...
public class TencentWeiboServiceImpl extends AbstractWeiboService implements WeiboService {
        ...
        if (weiboContents != null && !weiboContents.isEmpty()) {
            for (WeiboContent weiboContent : weiboContents) {
                ...
                if (retweetedContent == null) {
                    ...
                    String result = addWeibo(oauth, retweetedContent, txFollowerId);
                    ...
                    if (errorCode == 0) {
                        // success
                        String weiboId = analyzeWeiboId(response);
    ...
    private String addWeibo(OAuth oauth, WeiboContent weiboContent, Long txFollowerId) throws Exception {
        String result;
        ...
        if (errorCode == 2) {
            ...
            // success
            String weiboId = analyzeWeiboId(result);
    ...
    private String analyzeWeiboId(String result) throws JSONException {
