...
public class OAuthUpdateProfile {
	...
	/**
	 * Usage: java -DWeibo4j.oauth.consumerKey=[consumer key] -DWeibo4j.oauth.consumerSecret=[consumer secret] Weibo4j.examples.OAuthUpdateProfile [accessToken]
	 * [accessSecret] [imageFilePath]
	 * 
	 * @param args
	 *            message
	 */
