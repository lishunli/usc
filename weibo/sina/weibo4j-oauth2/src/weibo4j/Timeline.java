...
public class Timeline {
	 ...
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/public_timeline">statuses/public_timeline </a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/friends_timeline/ids"> statuses/friends_timeline/ids </a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/home_timeline"> statuses/home_timeline </a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.0
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/repost_timeline">statuses/repost_timeline</a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.0
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/repost_timeline/ids">statuses/repost_timeline/ids</a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.0
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/repost_by_me">statuses/repost_by_me</a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/mentions/ids">statuses/mentions/ids</a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.1
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/bilateral_timeline">statuses/bilateral_timeline</a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.0
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/hot/repost_daily">statuses/hot/repost_daily</a>
	 * @since JDK 1.5
	 */
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.0
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/destroy">statuses/destroy</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @throws IOException
	 * @since Weibo4J 1.2.1
	 * @see <a href="http://open.weibo.com/wiki/2/statuses/upload_url_text">2/statuses/upload url text </a>
	 */
	public Status uploadStatus(String status, String imageUrl) throws WeiboException, IOException {
		status = java.net.URLEncoder.encode(status, "utf-8");
		File imgFile = downloadImage("http://t2.qpic.cn/mblogpic/9726b4eaf9d8d9ec8188/2000");
		byte[] content = readFileImage(imgFile);
		ImageItem pic = new ImageItem(content);

		return this.UploadStatus(status, pic);
	}
	...
	private File downloadImage(String imgUrl) throws IOException {
		// // 创建流
		...
		// 存放地址
		File img = File.createTempFile(imgName, ".png");
		img.deleteOnExit();
	...
	private byte[] readFileImage(File file) throws IOException {
