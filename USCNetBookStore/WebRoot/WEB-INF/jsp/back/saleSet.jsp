...
<html>
	...
	function showMain()
	{
		...
		if (check_num(document.forms[0].salePrice.value))
		{
			...
			else
			{
				window.close();
				//刷新父页面
				window.location.href =  "saleSet.action?entityID=" + document.forms[0].entityID.value + "&type=1" + "&salePrice=" + document.forms[0].salePrice.value + "&priority=" +  document.forms[0].priority.value;
	...
	<body>
		...
		<s:form action="saleSet" method="post" theme="simple">
			<table>
				...
				<tr>
					...
					<td>
						<s:textfield name="discount" value="%{#parameters.discount}" readonly="true"></s:textfield>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<s:textfield name="salePriceTemp" value="%{#parameters.salePrice}" cssStyle="color: red"></s:textfield>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<s:textfield name="priority" id="priority" value="1"></s:textfield>
				...
				<tr>
					<td></td>
					<td>
						<input type="button" onclick="showMain()" value="设为促销">
